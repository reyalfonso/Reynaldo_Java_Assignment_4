...
public class Warsim {
  ...
  public static void main(String[] args) {
    ...
    if (file.exists()) {
      ...
      if(isContinue) {
        ...
        pArena = (Arena)things.get(3);
        enemy = (Warrior)things.get(4);
        eWeapon = (Weapon)things.get(5);
        eArmour = (Armour)things.get(6);
        eArena = (Arena)things.get(7);
  ...
  public static void createWeapon(String who, int choice) {
    switch (choice) {
      ...
      case 4: // Mace
        if(who.equals("Player")) {
          pWeapon = new Mace("Mace");
        }
        else {
          eWeapon = new Mace("Mace");
        }
        break;
      default:
        System.out.println("Oops!");
